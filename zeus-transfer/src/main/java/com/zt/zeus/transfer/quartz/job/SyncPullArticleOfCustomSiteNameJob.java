...
@Component
@EnableScheduling
public class SyncPullArticleOfCustomSiteNameJob {
    @Resource(name = "customSiteNamesByDateRange")
    private SyncPullArticleHandler.CustomSiteNamesByDateRange customSiteNamesByDateRange;

    @Resource(name = "CustomSiteNamesByTimeRange")
    private SyncPullArticleHandler.CustomSiteNamesByTimeRange customSiteNamesByTimeRange;
    ...
    public void execute() {
        ...
        if (Objects.equal(timeType, TimeType.YEAR) ||
            ...
            count = customSiteNamesByDateRange.handlerData(extraParams);
        } else {
            JSONObject extraParams = new JSONObject();
            extraParams.put("storageMode", StorageMode.INTERFACE);
            ...
            count = customSiteNamesByTimeRange.handlerData(extraParams);
        }
